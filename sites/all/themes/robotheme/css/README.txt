...
To use these stylesheets, rename the files and robotheme with the name of your theme.
...
robotheme-alpha-default-narrow.css  
...
robotheme-alpha-default-normal.css
...
robotheme-alpha-default-wide.css
